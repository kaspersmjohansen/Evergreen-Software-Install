...
*************************************************************************************************
.DESCRIPTION
    This script installs the latest Microsoft .NET Desktop Runtime 
...
$EvergreenApp = Get-EvergreenApp -Name Microsoft.NET | Where-Object {$_.Installer -eq "windowsdesktop" -and $_.Channel -eq "LTS" -and $_.Architecture -eq "x64"}
