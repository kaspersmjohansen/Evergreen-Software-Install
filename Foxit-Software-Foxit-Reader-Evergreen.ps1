...
<#
*************************************************************************************************
Name:               Foxit-Software-Foxit-Reader-Evergreen
Author:             Kasper Johansen
Website:            https://virtualwarlock.net            

*************************************************************************************************
.DESCRIPTION
    This script installs the latest Foxit Software Foxit Reader 
...
$InstallArguments = "REBOOT=ReallySuppress UPDATER_LANGUAGES_ID=0 DESKTOP_SHORTCUT=0 AUTO_UPDATE=0 /qn"
