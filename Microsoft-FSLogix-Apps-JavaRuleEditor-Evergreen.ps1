...
<#
*************************************************************************************************
Name:               Microsoft-FSLogix-Apps-JavaRuleEditor-Evergreen
...
$Vendor = "Microsoft"
$Product = "FSLogix Apps JavaRuleEditor"
...
Write-Host ""
Start-Process -FilePath "$Destination\x64\Release\FSLogixAppsJavaRuleEditorSetup.exe" -Wait -ArgumentList $InstallArguments