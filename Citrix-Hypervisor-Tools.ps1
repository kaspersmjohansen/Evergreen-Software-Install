...
<#
*************************************************************************************************
Name:               Citrix-Hypervisor-Tools
Author:             Kasper Johansen
Website:            https://virtualwarlock.net            

*************************************************************************************************
.DESCRIPTION
    This script installs the latest Citrix Hypervisor Tools 
...
$Vendor = "Citrix"
$Product = "Hypervisor Tools"
$EvergreenApp = Get-EvergreenApp -Name CitrixVMTools | Where-Object {$_.Architecture -eq "x64"} | Sort-Object -Descending | Select-Object -First 1
...
$InstallArguments = "/qn ALLOWDRIVERINSTALL=YES ALLOWAUTOUPDATE=NO ALLOWDRIVERUPDATE=NO IDENTIFYAUTOUPDATE=NO REBOOT=REALLYSUPPRESS"
