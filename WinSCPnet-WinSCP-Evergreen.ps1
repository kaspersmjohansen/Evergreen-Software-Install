...
<#
*************************************************************************************************
Name:               WinSCP.net-WinSCP-Evergreen
...
$Vendor = "WinSCP.net"
$Product = "WinSCP"
$EvergreenApp = Get-EvergreenApp -Name WinSCP | Where-Object {$_.Type -eq "exe"}
...
$InstallArguments = "/VERYSILENT /NORESTART /ALLUSERS"
...
Remove-Item -Path "$env:PUBLIC\Desktop\WinSCP.lnk"

#Disable automatic update
New-ItemProperty -Path "HKLM:SOFTWARE\Martin Prikryl\WinSCP 2" -Name DefaultUpdatesPeriod -Value 0 -PropertyType DWORD